...
def test_ddlInsert(mocker):
    befour_db_name = "test/db/dbversion/dbUpdateFrom08/befour_data.db"
    ...
    dbversion.dbUpdateFrom08()
    assert filecmp.cmp(test_file_name, "test/db/dbversion/dbUpdateFrom08/result_ok.db")
