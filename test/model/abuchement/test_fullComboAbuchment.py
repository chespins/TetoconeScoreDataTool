...
def test_empty():
    testObj = setup_test()
    input_list = []
    assert testObj.fullComboAbuchment(input_list, False) == []
...
def test_one_data_false():
    ...
    assert testObj.fullComboAbuchment(input_list, False) == success
...
def test_one_data_true():
    ...
    assert testObj.fullComboAbuchment(input_list, True) == success
...
def test_one_unmatch_data_true():
    ...
    assert testObj.fullComboAbuchment(input_list, True) == []
